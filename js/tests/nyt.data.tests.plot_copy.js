...
function NYTTestPlot()
{
    ...
    this.addGraph('g00',this.mergeData(term_war_scope_complete,'War'))
        .addData(this.mergeData(term_peace_scope_complete,'Peace'));

    this.addGraph('g01', this.mergeData(term_war_scope_complete,'War'));
    this.addGraph('g02', this.mergeData(term_peace_scope_complete,'Peace'));
